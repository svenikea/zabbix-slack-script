...
unit1_recipients, unit2_recipients, unit3_recipients, unit4_recipients, all_unit = [***REMOVED***, ***REMOVED***], [***REMOVED***, ***REMOVED***], [***REMOVED***, ***REMOVED***], [***REMOVED***, ***REMOVED***], "<!channel>"
## Message template
channel_id, subject, message, sendto, response_channel = sys.argv[1], sys.argv[2], sys.argv[3], None, [***REMOVED***]
slack_token = "***REMOVED***" # <= Put the token here
